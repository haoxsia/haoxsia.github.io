...
With the rapid development of semiconductor industry, advanced manufacturing technologies have attracted researchers' attention in fabricating micron and nanoscale devices, such as breath/blood pressure sensors in health monitoring [^1], microfluidics [^2] in biological analysis, accelerators [^3] and gyroscopes [^4] in mobile phones, and RF components [^5] in modern industry. For these reasons, micro/nanoelectromechanical systems (MEMS/NEMS) are promising ideals, thanks to their small scales and physical properties control. By 2022, there remains a huge market for MEMS products of about $20B around the world. To date, silicon nitride (SiN) membrane can easily achieved with a conventional LPCVD process and features high mechanical properties (e.g., tensile stress) and low optical loss. High Q silicon nitride membrane resonator becomes one of excellent device candidates for fundamental research and applications. So we present a detailed fabrication process for developing silicon nitride membrane nanoelectromechanical resonator.
